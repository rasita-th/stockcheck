...
`site/index.html` ใน source ยังอาจมี legacy references ที่ถูกลบโดย `scripts/prepare_stable_site_v9_4_1.py` ระหว่าง build ดังนั้นการตรวจ raw source โดยตรงจะให้ false failure แม้ Pages artifact สุดท้ายสะอาด

preflight ใหม่จึงทำงานแบบนี้:
...
> การ preview ตรงจาก `site/` อาจยังเป็น source ก่อน preparation หากต้องการ preview artifact แบบเดียวกับ production ให้ copy repository ไป temporary directory แล้วรัน preparation ก่อน หรือใช้ workflow preview ในอนาคต
