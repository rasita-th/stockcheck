...
# Earnings may render 30 rows, but only portfolio/related rows are eligible and
# all non-detail contexts share a five-attempt page budget. One slot remains
# available for the selected Stock Detail logo.
